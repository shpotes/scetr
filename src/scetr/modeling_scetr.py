# coding=utf-8
# Copyright 2021 Facebook AI Research The HuggingFace Inc. team. and Santiago Hincapie-Potes All rights reserved.
#
...
from transformers.models.detr import (
    DetrModel,
    DetrPreTrainedModel, 
...
from .configuration_scetr import DetrConfig

if is_vision_available():
    from .feature_extraction_scetr import center_to_corners_format

logger = logging.get_logger(__name__)

_CONFIG_FOR_DOC = "ScetrConfig"
...
@dataclass
class ScetrRotatedObjectDetectionOutput(DetrObjectDetectionOutput):
    loss: Optional[torch.FloatTensor] = None
    loss_dict: Optional[Dict] = None
    logits: torch.FloatTensor = None
    pred_rot_boxes: torch.FloatTensor = None
...
class ScetrForRotatedObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        return ScetrRotatedObjectDetectionOutput(
            loss=loss,
            loss_dict=loss_dict,
            logits=logits,
            pred_rot_boxes=pred_boxes,
...
class DetrLoss(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        loss_giou = 1 - torch.diag(
            generalized_box_iou( # TODO: replace this
